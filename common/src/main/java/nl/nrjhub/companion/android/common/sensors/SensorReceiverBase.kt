...
import nl.nrjhub.companion.android.common.util.CHANNEL_SENSOR_SYNC
import nl.nrjhub.companion.android.database.AppDatabase
import nl.nrjhub.companion.android.database.sensor.SensorDao
import nl.nrjhub.companion.android.database.sensor.SensorWithAttributes
import nl.nrjhub.companion.android.database.sensor.toSensorWithAttributes
import nl.nrjhub.companion.android.database.sensor.toSensorsWithAttributes
...
abstract class SensorReceiverBase : BroadcastReceiver() {
    companion object {
        const val ACTION_UPDATE_SENSOR = "nl.nrjhub.companion.android.UPDATE_SENSOR"
        const val ACTION_UPDATE_SENSORS = "nl.nrjhub.companion.android.UPDATE_SENSORS"
        const val ACTION_STOP_BEACON_SCANNING = "nl.nrjhub.companion.android.STOP_BEACON_SCANNING"
