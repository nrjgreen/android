...
import nl.nrjhub.companion.android.nfc.NfcSetupActivity
import nl.nrjhub.companion.android.onboarding.OnboardApp
import nl.nrjhub.companion.android.settings.controls.ManageControlsSettingsFragment
import nl.nrjhub.companion.android.settings.developer.DeveloperSettingsFragment
import nl.nrjhub.companion.android.settings.language.LanguagesProvider
import nl.nrjhub.companion.android.settings.notification.NotificationChannelFragment
import nl.nrjhub.companion.android.settings.notification.NotificationHistoryFragment
import nl.nrjhub.companion.android.settings.qs.ManageTilesFragment
import nl.nrjhub.companion.android.settings.sensor.SensorSettingsFragment
import nl.nrjhub.companion.android.settings.sensor.SensorUpdateFrequencyFragment
import nl.nrjhub.companion.android.settings.server.ServerSettingsFragment
import nl.nrjhub.companion.android.settings.shortcuts.ManageShortcutsSettingsFragment
import nl.nrjhub.companion.android.settings.vehicle.ManageAndroidAutoSettingsFragment
import nl.nrjhub.companion.android.settings.wear.SettingsWearActivity
import nl.nrjhub.companion.android.settings.wear.SettingsWearDetection
import nl.nrjhub.companion.android.settings.widgets.ManageWidgetsSettingsFragment
