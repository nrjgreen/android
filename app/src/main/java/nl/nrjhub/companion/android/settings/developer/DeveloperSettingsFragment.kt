package nl.nrjhub.companion.android.settings.developer
...
import nl.nrjhub.companion.android.settings.developer.location.LocationTrackingFragment
import nl.nrjhub.companion.android.settings.log.LogFragment
    ...
    override fun onCreatePreferences(savedInstanceState: Bundle?, rootKey: String?) {
        ...
        findPreference<Preference>("show_share_logs")?.setOnPreferenceClickListener {
            parentFragmentManager.commit {
                ...
                addToBackStack(getString(nl.nrjhub.companion.android.common.R.string.log))
            }
        ...
        findPreference<Preference>("location_tracking")?.let {
            ...
            it.setOnPreferenceClickListener {
                parentFragmentManager.commit {
                    ...
                    addToBackStack(getString(nl.nrjhub.companion.android.common.R.string.location_tracking))
                }
                return@setOnPreferenceClickListener true
            }
        }
