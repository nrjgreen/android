package nl.nrjhub.companion.android.settings.shortcuts
...
import nl.nrjhub.companion.android.database.IconDialogCompat
...
import nl.nrjhub.companion.android.widgets.assist.AssistShortcutActivity
        ...
        val shortcut = ShortcutInfo.Builder(app, shortcutId)
            ...
            .setIcon(
                if (icon != null) {
                    ...
                    Icon.createWithResource(app, nl.nrjhub.companion.android.R.mipmap.logo_nrjhub)
                }
            )
            .setIntent(intent)
            .build()
