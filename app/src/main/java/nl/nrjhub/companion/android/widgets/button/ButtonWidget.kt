...
import nl.nrjhub.companion.android.widgets.common.WidgetAuthenticationActivity
...
class ButtonWidget : AppWidgetProvider() {
    companion object {
        ...
        const val CALL_SERVICE =
            "nl.nrjhub.companion.android.widgets.button.ButtonWidget.CALL_SERVICE"
        private const val CALL_SERVICE_AUTH =
            "nl.nrjhub.companion.android.widgets.button.ButtonWidget.CALL_SERVICE_AUTH"
        internal const val RECEIVE_DATA =
            "nl.nrjhub.companion.android.widgets.button.ButtonWidget.RECEIVE_DATA"
