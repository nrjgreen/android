package nl.nrjhub.companion.android.widgets.mediaplayer
...
import nl.nrjhub.companion.android.database.widget.WidgetBackgroundType
import nl.nrjhub.companion.android.util.hasActiveConnection
import nl.nrjhub.companion.android.widgets.BaseWidgetProvider
...
class MediaPlayerControlsWidget : BaseWidgetProvider() {
    ...
    companion object {
        ...
        internal const val RECEIVE_DATA =
            "nl.nrjhub.companion.android.widgets.media_player_controls.MediaPlayerControlsWidget.RECEIVE_DATA"
        internal const val UPDATE_MEDIA_IMAGE =
            "nl.nrjhub.companion.android.widgets.media_player_controls.MediaPlayerControlsWidget.UPDATE_MEDIA_IMAGE"
        internal const val CALL_PREV_TRACK =
            "nl.nrjhub.companion.android.widgets.media_player_controls.MediaPlayerControlsWidget.CALL_PREV_TRACK"
        internal const val CALL_REWIND =
            "nl.nrjhub.companion.android.widgets.media_player_controls.MediaPlayerControlsWidget.CALL_REWIND"
        internal const val CALL_PLAYPAUSE =
            "nl.nrjhub.companion.android.widgets.media_player_controls.MediaPlayerControlsWidget.CALL_PLAYPAUSE"
        internal const val CALL_FASTFORWARD =
            "nl.nrjhub.companion.android.widgets.media_player_controls.MediaPlayerControlsWidget.CALL_FASTFORWARD"
        internal const val CALL_NEXT_TRACK =
            "nl.nrjhub.companion.android.widgets.media_player_controls.MediaPlayerControlsWidget.CALL_NEXT_TRACK"
        internal const val CALL_VOLUME_DOWN =
            "nl.nrjhub.companion.android.widgets.media_player_controls.MediaPlayerControlsWidget.CALL_VOLUME_DOWN"
        internal const val CALL_VOLUME_UP =
            "nl.nrjhub.companion.android.widgets.media_player_controls.MediaPlayerControlsWidget.CALL_VOLUME_UP"
