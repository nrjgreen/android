package nl.nrjhub.companion.android.notifications
...
import nl.nrjhub.companion.android.authenticator.Authenticator
import nl.nrjhub.companion.android.common.R as commonR
import nl.nrjhub.companion.android.common.data.prefs.PrefsRepository
import nl.nrjhub.companion.android.common.data.servers.ServerManager
import nl.nrjhub.companion.android.common.notifications.DeviceCommandData
import nl.nrjhub.companion.android.common.notifications.NotificationData
import nl.nrjhub.companion.android.common.notifications.clearNotification
import nl.nrjhub.companion.android.common.notifications.commandBeaconMonitor
import nl.nrjhub.companion.android.common.notifications.commandBleTransmitter
import nl.nrjhub.companion.android.common.notifications.createChannelID
import nl.nrjhub.companion.android.common.notifications.getGroupNotificationBuilder
import nl.nrjhub.companion.android.common.notifications.handleChannel
import nl.nrjhub.companion.android.common.notifications.handleColor
import nl.nrjhub.companion.android.common.notifications.handleDeleteIntent
import nl.nrjhub.companion.android.common.notifications.handleSmallIcon
import nl.nrjhub.companion.android.common.notifications.handleText
import nl.nrjhub.companion.android.common.notifications.parseColor
import nl.nrjhub.companion.android.common.notifications.parseVibrationPattern
import nl.nrjhub.companion.android.common.notifications.prepareText
import nl.nrjhub.companion.android.common.util.TextToSpeechData
import nl.nrjhub.companion.android.common.util.cancelGroupIfNeeded
import nl.nrjhub.companion.android.common.util.getActiveNotification
import nl.nrjhub.companion.android.common.util.speakText
import nl.nrjhub.companion.android.common.util.stopTTS
...
import nl.nrjhub.companion.android.database.settings.WebsocketSetting
import nl.nrjhub.companion.android.sensors.LocationSensorManager
import nl.nrjhub.companion.android.sensors.NotificationSensorManager
import nl.nrjhub.companion.android.sensors.SensorReceiver
import nl.nrjhub.companion.android.settings.SettingsActivity
import nl.nrjhub.companion.android.util.UrlUtil
import nl.nrjhub.companion.android.vehicle.HaCarAppService
import nl.nrjhub.companion.android.websocket.WebsocketManager
import nl.nrjhub.companion.android.webview.WebViewActivity
import java.io.File
            ...
            if (data.containsKey("action_${i}_key")) {
                ...
                when (notificationAction.key) {
                    ...
                    REPLY -> {
                        ...
                        builder.addAction(
                            nl.nrjhub.companion.android.R.mipmap.logo_nrjhub_foreground,
                            notificationAction.title,
                            actionPendingIntent
                        )
                    }
