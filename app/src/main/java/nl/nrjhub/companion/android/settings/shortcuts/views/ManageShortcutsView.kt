package nl.nrjhub.companion.android.settings.shortcuts.views
...
import nl.nrjhub.companion.android.settings.shortcuts.ManageShortcutsViewModel
    ...
    Row(verticalAlignment = Alignment.CenterVertically) {
        ...
        OutlinedButton(onClick = {
            ...
            val painter = if (icon != null) {
                ...
                painterResource(nl.nrjhub.companion.android.R.drawable.logo_nrjhub)
            }
