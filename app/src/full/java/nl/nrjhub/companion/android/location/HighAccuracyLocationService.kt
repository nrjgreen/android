package nl.nrjhub.companion.android.location
...
import nl.nrjhub.companion.android.common.util.CHANNEL_HIGH_ACCURACY
import nl.nrjhub.companion.android.sensors.LocationSensorManager
import nl.nrjhub.companion.android.util.ForegroundServiceLauncher
    ...
    companion object {
        ...
        private fun createNotificationBuilder(context: Context) {
            ...
            notificationBuilder = NotificationCompat.Builder(context, CHANNEL_HIGH_ACCURACY)
                .setSmallIcon(nl.nrjhub.companion.android.R.mipmap.logo_nrjhub)
                .setColor(Color.GRAY)
                .setOngoing(true)
