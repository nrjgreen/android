...
import nl.nrjhub.companion.android.common.bluetooth.BluetoothUtils
...
import nl.nrjhub.companion.android.common.data.integration.containsWithAccuracy
...
import nl.nrjhub.companion.android.common.util.DisabledLocationHandler
import nl.nrjhub.companion.android.database.AppDatabase
import nl.nrjhub.companion.android.database.location.LocationHistoryItem
import nl.nrjhub.companion.android.database.location.LocationHistoryItemResult
import nl.nrjhub.companion.android.database.location.LocationHistoryItemTrigger
...
import nl.nrjhub.companion.android.database.sensor.SensorSettingType
import nl.nrjhub.companion.android.database.sensor.toSensorWithAttributes
import nl.nrjhub.companion.android.location.HighAccuracyLocationService
import nl.nrjhub.companion.android.notifications.MessagingManager
...
class LocationSensorManager : BroadcastReceiver(), SensorManager {
    ...
    companion object {
        ...
        const val ACTION_REQUEST_LOCATION_UPDATES =
            "nl.nrjhub.companion.android.background.REQUEST_UPDATES"
        const val ACTION_REQUEST_ACCURATE_LOCATION_UPDATE =
            "nl.nrjhub.companion.android.background.REQUEST_ACCURATE_UPDATE"
        const val ACTION_PROCESS_LOCATION =
            "nl.nrjhub.companion.android.background.PROCESS_UPDATES"
        const val ACTION_PROCESS_HIGH_ACCURACY_LOCATION =
            "nl.nrjhub.companion.android.background.PROCESS_HIGH_ACCURACY_UPDATES"
        const val ACTION_PROCESS_GEO =
            "nl.nrjhub.companion.android.background.PROCESS_GEOFENCE"
        const val ACTION_FORCE_HIGH_ACCURACY =
            "nl.nrjhub.companion.android.background.FORCE_HIGH_ACCURACY"
