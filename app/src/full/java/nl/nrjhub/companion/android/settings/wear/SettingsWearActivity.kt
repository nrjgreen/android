...
import nl.nrjhub.companion.android.databinding.ActivitySettingsWearBinding
import nl.nrjhub.companion.android.settings.HelpMenuProvider
import nl.nrjhub.companion.android.settings.wear.views.SettingsWearMainView
...
class SettingsWearActivity : AppCompatActivity(), CapabilityClient.OnCapabilityChangedListener {
    ...
    companion object {
        ...
        private const val PLAY_STORE_APP_URI =
            "market://details?id=nl.nrjhub.companion.android"
