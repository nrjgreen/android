...
import nl.nrjhub.companion.android.common.sensors.AndroidOsSensorManager
import nl.nrjhub.companion.android.common.sensors.AudioSensorManager
import nl.nrjhub.companion.android.common.sensors.BatterySensorManager
import nl.nrjhub.companion.android.common.sensors.BluetoothSensorManager
import nl.nrjhub.companion.android.common.sensors.DNDSensorManager
import nl.nrjhub.companion.android.common.sensors.DisplaySensorManager
import nl.nrjhub.companion.android.common.sensors.KeyguardSensorManager
import nl.nrjhub.companion.android.common.sensors.LastRebootSensorManager
import nl.nrjhub.companion.android.common.sensors.LastUpdateManager
import nl.nrjhub.companion.android.common.sensors.LightSensorManager
import nl.nrjhub.companion.android.common.sensors.MobileDataManager
import nl.nrjhub.companion.android.common.sensors.NetworkSensorManager
import nl.nrjhub.companion.android.common.sensors.NextAlarmManager
import nl.nrjhub.companion.android.common.sensors.NfcSensorManager
import nl.nrjhub.companion.android.common.sensors.PhoneStateSensorManager
import nl.nrjhub.companion.android.common.sensors.PowerSensorManager
import nl.nrjhub.companion.android.common.sensors.PressureSensorManager
import nl.nrjhub.companion.android.common.sensors.ProximitySensorManager
import nl.nrjhub.companion.android.common.sensors.SensorManager
import nl.nrjhub.companion.android.common.sensors.SensorReceiverBase
import nl.nrjhub.companion.android.common.sensors.StepsSensorManager
import nl.nrjhub.companion.android.common.sensors.StorageSensorManager
import nl.nrjhub.companion.android.common.sensors.TimeZoneManager
import nl.nrjhub.companion.android.common.sensors.TrafficStatsManager
import nl.nrjhub.companion.android.home.HomeActivity
import nl.nrjhub.companion.android.home.views.DEEPLINK_SENSOR_MANAGER
...
class SensorReceiver : SensorReceiverBase() {
    ...
    companion object {
        ...
        const val ACTION_REQUEST_SENSORS_UPDATE =
            "nl.nrjhub.companion.android.background.REQUEST_SENSORS_UPDATE"
