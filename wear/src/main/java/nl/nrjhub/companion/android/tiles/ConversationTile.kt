...
import nl.nrjhub.companion.android.conversation.ConversationActivity
                    ...
                    ImageResource.Builder()
                        .setAndroidResourceByResId(
                            ResourceBuilders.AndroidImageResourceByResId.Builder()
                                .setResourceId(nl.nrjhub.companion.android.R.drawable.ic_comment_processing_outline)
                                .build()
                        )
                        .build()
                )
